...
INSERT INTO PROPRIETAIRE (idPropri, nom, prenom, tel, mail, iban)
VALUES (2, 'MARTIN', 'Lucas', '0602020202', 'MartinLucas@example.com', 'FRXXXXXXXXXXXXXXXXXXXXX03');
...
INSERT INTO PROPRIETAIRE (idPropri, nom, prenom, tel, mail, iban)
VALUES (5, 'JEAN', 'Mark', '0605050505', 'JeanMark@example.com', 'FRXXXXXXXXXXXXXXXXXXXXXXX07');

-- Insertion de plusieurs Locataire

INSERT INTO LOCATAIRE (idLocataire, nom, prenom, tel, mail, iban)
...
INSERT INTO LOCATAIRE (idLocataire, nom, prenom, tel, tel, iban)
...
INSERT INTO BIEN (idBien, idAgence, idPropri, idSyndic, adresse, typeBail, surface)
Values (4,  5, 5, 5, 'Rochefort, France', 3,, 25);
