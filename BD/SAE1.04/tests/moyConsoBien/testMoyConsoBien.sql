...
-- date         : décembre 2022
-- role         : tests pour Quelle est la moyenne de consommation par bien  ?
-- projet       : gestloc
-- ==========================
...
-- Cas 1 : un logement a de la consommation
...
-- Insertion de son DPE pour la consommation
...
-- Insertion d'un deuxième logement pour les TABLE_STATS

-- Insertion du prorietaire pour les dépendances
INSERT INTO PROPRIETAIRE (IDPROPRI, NOM, PRENOM, TEL, MAIL, IBAN)
VALUES(2, 'MARTIN', 'Lou', '0602020202', 'MartinLou@example.com', 'FR4414508000503575763697X53');

-- Insertion du bien concerné
INSERT INTO BIEN (IDBIEN, IDPROPRI, IDAGENCE, IDSYNDIC, ADRESSE, TYPEBAIL, SURFACE)
VALUES(2, 2, 1, 1, 'La Rochelle', 3, 70);

-- Insertion de son DPE pour la consommation
INSERT INTO DPE (IDDPE, IDBIEN, DATEDEBUT, DATEFIN, CLASSEENERGIE, CLASSECLIMAT, CONSOMMATION, EMISSIONS)
VALUES(2, 2, to_date('23/12/2021', 'DD/MM/YYYY'), to_date('22/12/2031', 'DD/MM/YYYY'), 'G', 'G', 424, 103);
...
SPOOL testMoyConsoBien.out  
PROMPT fichier resultat du test : testMoyConsoBien.out 
